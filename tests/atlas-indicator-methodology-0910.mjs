...
assert.match(territoryCurrent,/0914-html1/);
assert.match(territoryCurrent,/atlas-territory-igr-v2a-0914\.css\?v=0914-1/);
assert.match(territoryResponsive,/HTML responsive authority 0\.91\.4/);
