...
assert.equal(release.release,'0.44.8');
assert.equal(release.build,'0448');
...
console.log(`ATLAS Entity 360 single-workspace + route authority contract OK under release ${release.release}/${release.build}`);
