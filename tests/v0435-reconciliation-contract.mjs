...
assert.equal(release.release,'0.43.5');
assert.equal(release.build,'0435');
assert.equal(manifest.release,'0.43.5');
assert.equal(manifest.build,'0435');
assert.equal(build.app_version,'0.43.5');
assert.equal(build.build,'0435');
...
console.log('ATLAS reconciliation 0.43.5 contract OK');
