...
assert.match(js,/ENTITY-CONSOLIDATION-0521\.2/);
assert.match(js,/personas y control/);
assert.match(js,/Personas, propiedad y control/);
assert.match(js,/querySelectorAll\('aside,nav,.sidebar,.v019-nav,.nav,\[role="navigation"\]'\)/);
assert.match(js,/guardRetiredRoute/);
...
assert.match(index,/atlas-entity-consolidation-0521\.js\?v=0521-2/);
...
console.log('ATLAS entity consolidation 0521.2 contract OK');
