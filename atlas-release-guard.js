'use strict';
/* ATLAS AML · single active release authority 0.96.2 · build 0963 · freeze-safe
...
(function atlasSingleReleaseAuthority(){
  ...
  const active={release:'0.96.2',build:'0963'};
  ...
  function applyRelease(){
    ...
    try{
      ...
      window.__AML_VERSION_SOURCE__='atlas-release-guard-0963-freeze-safe';
