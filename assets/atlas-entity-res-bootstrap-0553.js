'use strict';
/* ATLAS AML 0.55.6 · bootstrap de contexto RES.
 * Carga sólo recursos same-origin permitidos por la CSP existente.
 */
(function atlasEntityResBootstrap0556(){
  const VERSION='0556-1';
  ...
  css(`./assets/atlas-entity-res-lifecycle-0556.css?v=${VERSION}`,'atlas-entity-res-lifecycle-0556-css');
        ...
        script(`./assets/atlas-entity-res-intelligence-0553.js?v=${VERSION}`,'atlas-entity-res-intelligence-0553-js',()=>{
          script(`./assets/atlas-res-cross-surface-0554.js?v=${VERSION}`,'atlas-res-cross-surface-0554-js',()=>{
            script(`./assets/atlas-res-reconciliation-0555.js?v=${VERSION}`,'atlas-res-reconciliation-0555-js',()=>{
              script(`./assets/atlas-entity-res-lifecycle-0556.js?v=${VERSION}`,'atlas-entity-res-lifecycle-0556-js',()=>{
                window.__ATLAS_ENTITY_RES_BOOTSTRAP__={active:true,release:'0.55.6',build:'0556',sameOriginAssets:true,surfaces:['explorer','quick-sheet','entity360','entity-intelligence','mercado-publico','sanciones','conciliacion-uaf-sii','res-lifecycle-evidence'],installedAt:new Date().toISOString()};
              });
            });
          });
        });
